$(document).ready(function() {
    ...
    $('#mapModal').on('shown.bs.modal', function(e) {
        google.maps.event.addDomListener(document.getElementById("map_canvas"), 'load', initialize());
    });
    ...
    google.maps.event.addDomListener(document.getElementById("map_canvas"), 'resize', initialize);
