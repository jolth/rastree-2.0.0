/* [ ---- Gebo Admin Panel - location finder ---- ] */
    ...
    function marker_message() {
        $.sticky('Arrastre el marcador para ajustar la posición.', {autoclose : 5000, position: "top-center", type: "st-info" });
    };
    ...
    gebo_maps = {
        ...
        save_location: function() {
			...
			location_add_form.on('click','button', function() {
                ...
                $.sticky("Se ha guardado la ubicación exitosamente.", {autoclose : 5000, position: "top-center", type: "st-info" });
            });  
        },
